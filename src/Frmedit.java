...
public class Frmedit extends javax.swing.JDialog {
    ...
    public Frmedit(java.awt.Frame parent, boolean modal) {
        ...
        frm = (FrmStaff)parent;
         try {
            ...
            txtdep.setSelectedItem(frm.table_data.getValueAt(index, 2).toString());
            txtpos.setSelectedItem(frm.table_data.getValueAt(index, 3).toString());
            txtsalary.setText(frm.table_data.getValueAt(index, 4).toString());
        ...
        // Select combo cox
          try{
            ...
            rs = st.executeQuery("SELECT * FROM tblposition");
            while(rs.next()){
                String name = rs.getString("posid");
                txtpos.addItem(name);
            }
            rs.close();
          ...
          try{
            con = DBManager.getConnection();
            st = con.createStatement();
            rs = st.executeQuery("SELECT * FROM tbldepartment");
            while(rs.next()){
                String name = rs.getString("depid");
                txtdep.addItem(name);
            }
    ...
    private void btnsearchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsearchActionPerformed
       ...
       String pos = txtpos.getSelectedItem().toString();
       double salary = Double.parseDouble(txtsalary.getText());
       String sqlupdate = "Update tblstaff set Name ='"+name+"',depid='" +dep + "',posid ='" +pos + "',salary='" +salary+"' "
